      ...
      <div className='home__products'>
         <section className='home__products--item-top home__products--sections'>
            <div className='home__products--container-top'>
               <picture>
                  <source
                     srcSet={'https://github.com/idrisaltamimi/e-commerce-app-audiophile/blob/main/src/assets/home/desktop/image-speaker-zx9.png?raw=true'} media='(min-width: 769px)' />

                  <source
                     srcSet={'https://github.com/idrisaltamimi/e-commerce-app-audiophile/blob/main/src/assets/home/tablet/image-speaker-zx9.png?raw=true'} media='(min-width: 376px)' />

                  <img className='home__products--top-img' alt='a png of zx9 speaker'
                     src={'https://github.com/idrisaltamimi/e-commerce-app-audiophile/blob/main/src/assets/home/mobile/image-speaker-zx9.png?raw=true'} />
               </picture>
         ...
         <section className='home__products--item-bottom home__products--sections'>
            <picture>
               <source
                  srcSet={'https://github.com/idrisaltamimi/e-commerce-app-audiophile/blob/main/src/assets/home/desktop/image-earphones-yx1.jpg?raw=true'} media='(min-width: 1300px)' />

               <source
                  srcSet={'https://github.com/idrisaltamimi/e-commerce-app-audiophile/blob/main/src/assets/home/tablet/image-earphones-yx1.jpg?raw=true'} media='(min-width: 835px)' />

               <img className='home__products--bottom-img home__products--sections' alt='a png of zx7 speaker'
                  src={'https://github.com/idrisaltamimi/e-commerce-app-audiophile/blob/main/src/assets/home/mobile/image-earphones-yx1.jpg?raw=true'} />
            </picture>
